...
H= m(T_{s} - T_{a}) +  c    %SJS: I don't know why you had written \pm c(H). Since c is reported as positive or negative values and not a function of H, it should be + c. Correct?
\end{equation}
