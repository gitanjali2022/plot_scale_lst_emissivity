...
%SJS: Then you will need to create a separate pdf for the SI, right?
...
\begin{figure}[h!]
	...
	\end{overpic}
	\setlength{\belowcaptionskip}{-3ex}
	\caption{(a) Uncertainty in plot-scale $\epsilon$ using the short equation (Seq) or the long equation (Leq, with and without intercept). (b) Uncertainty in hourly $\Delta T$ using long equation with and without intercept for July 15. 
	}
	\label{fig:unc_intrc}
\end{figure}
