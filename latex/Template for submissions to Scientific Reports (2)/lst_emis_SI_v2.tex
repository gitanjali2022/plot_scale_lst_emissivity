...
The resulting intercept values ranged from -24 to +258 W m$^{-2}$, i.e. up to 70\% of the maximum observed sensible heat flux at a site (e.g. at HS and TUM). %SJS: I don't think we can say much more, as the alleged pattern between closed and open canopies does not work out, given the negative intercept at Yatir and Daly uncleared. Also AR is not really a closed canopy.
